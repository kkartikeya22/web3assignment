/*The class Car only include the attributes and methods asked to be made in the assignment. For inputting the data a separate class has to be made which the present class and can implement all the methods of the class Car */
...
public class Car{
    ...
    public void move(){
        ...
        y=y+speed*(int)a[1];//increasing the y coordinate with the component of velocity in x-direction
        z+=speed*(int)a[2];//increasing the z coordinate with the component of velocity in x-direction
    }
